...
},{}],"739kw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//export
parcelHelpers.export(exports, "loadCircuits", ()=>loadCircuits
);
//export
parcelHelpers.export(exports, "printCircuits", ()=>printCircuits
);
...
function loadCircuits() {
    fetch("https://ergast.com/api/f1/current.json").then((response)=>response.json()
    ).then((data)=>printCircuits(data["MRData"]["RaceTable"]["Races"])
    );
}
function printCircuits(table) {
    ...
    for(let i in table){
        ...
        const fecha = new Date(parseInt(fechaArr[0]), //Meses empiezan de 0
        parseInt(fechaArr[1] - 1), parseInt(fechaArr[2]));
        fechaElement.innerHTML = _dateFns.format(fecha, "d LLLL yyyy", {
            locale: _locale.es
        });
        carreras.appendChild(fechaElement);
        let faltaRes = "";
        const compDate = _dateFns.compareAsc(new Date(), fecha);
        if (compDate === 1) faltaRes = "Finalizada";
        else if (compDate === 0) faltaRes = "¡Es hoy!";
        else faltaRes = `${_dateFns.formatDistance(fecha, new Date(), {
            locale: _locale.es
        })}`;
...
},{"date-fns":"9yHCA","date-fns/locale":"lASMG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9yHCA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./_lib/formatDistance/index.js":"6Hpp9","./_lib/formatLong/index.js":"9GCxd","./_lib/formatRelative/index.js":"2rWZv","./_lib/localize/index.js":"bXdjo","./_lib/match/index.js":"4yKYK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6Hpp9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var formatDistanceLocale = {
    lessThanXSeconds: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9GCxd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../../_lib/buildFormatLongFn/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../../_lib/buildFormatLongFn/index.js":"h1FGd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2rWZv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var formatRelativeLocale = {
...
var formatRelative = function(token, date, _baseDate, _options) {
    if (date.getUTCHours() !== 1) return formatRelativeLocalePlural[token];
    else return formatRelativeLocale[token];
};
exports.default = formatRelative;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bXdjo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../../_lib/buildLocalizeFn/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../../_lib/buildLocalizeFn/index.js":"5l2rZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4yKYK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
//# sourceMappingURL=enlaces.f72b641a.js.map
